package pt.up.fe.specs.jsweaver.abstracts.weaver;
...
/**
 * Abstract Weaver Implementation for JsWeaver<br>
 ...
 * The abstract class {@link pt.up.fe.specs.jsweaver.abstracts.AJsWeaverJoinPoint} can be used to add user-defined methods and fields which the user intends to add for all join points and are not intended to be used in LARA aspects.
