...
/**
 * Auto-Generated class for join point ADoWhileStatement
 * This class is overwritten by the Weaver Generator.
 * 
 * 
 * @author Lara Weaver Generator
 */
public abstract class ADoWhileStatement extends ALoop {
     ...
     * 
     */
    public ADoWhileStatement(ALoop aLoop){
        this.aLoop = aLoop;
    }
    /**
     * Test expression of this do while statement.
     */
    ...
    protected enum DoWhileStatementAttributes {
         ...
         * 
         */
        private DoWhileStatementAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<DoWhileStatementAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(DoWhileStatementAttributes::name).collect(Collectors.toList());
        }
