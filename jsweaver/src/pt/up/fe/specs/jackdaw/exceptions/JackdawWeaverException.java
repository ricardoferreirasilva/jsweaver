 ...
 */
public class JackdawWeaverException extends BaseException {
     ...
     */
    public JackdawWeaverException(String event){
        this(event,null);
    }
    /**
     ...
     */
    public JackdawWeaverException(String event, Throwable cause){
        super(cause);
        this.event = event;
    }
    /**
